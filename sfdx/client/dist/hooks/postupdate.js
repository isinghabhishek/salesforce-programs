...
function suggestAlternatives() {
    core_1.CliUx.ux.log('Failed to update sf. Try uninstalling the CLI and re-installing it.');
    core_1.CliUx.ux.log('Uninstall instructions: https://developer.salesforce.com/docs/atlas.en-us.234.0.sfdx_setup.meta/sfdx_setup/sfdx_setup_uninstall.htm');
    if (process.platform === 'win32') {
        core_1.CliUx.ux.log('- installer: https://developer.salesforce.com/media/salesforce-cli/sf/channels/stable/sf-x64.exe');
    }
    else if (process.platform === 'darwin') {
        core_1.CliUx.ux.log('- installer: https://developer.salesforce.com/media/salesforce-cli/sf/channels/stable/sf.pkg');
    }
    else {
        core_1.CliUx.ux.log('- download: https://developer.salesforce.com/media/salesforce-cli/sf/channels/stable/sf-linux-x64.tar.gz');
    }
}
/**
...
const hook = async function (opts) {
    let success = false;
    core_1.CliUx.ux.action.start('sfdx-cli: Updating sf');
    try {
