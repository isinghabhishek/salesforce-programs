...
const logError = (msg) => {
    core_1.CliUx.ux.log('NOTE: This error can be ignored in CI and may be silenced in the future');
    core_1.CliUx.ux.log('- Set the SFDX_HIDE_RELEASE_NOTES env var to "true" to skip this script\n');
    core_1.CliUx.ux.log(msg.toString());
};
/*
