...
declare type PackageVersionListCommandResult = Omit<PackageVersionListResult, 'HasMetadataRemoved' | 'IsReleased' | 'IsPasswordProtected' | 'HasPassedCodeCoverageCheck' | 'CreatedById' | 'BuildDurationInSeconds' | 'CodeCoverage' | 'Package2'> & {
...
export declare class PackageVersionListCommand extends SfdxCommand {
    ...
    run(): Promise<PackageVersionListCommandResult[]>;
