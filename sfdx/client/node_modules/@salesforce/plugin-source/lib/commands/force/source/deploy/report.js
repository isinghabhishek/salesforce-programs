...
class Report extends deployCommand_1.DeployCommand {
    ...
    formatResult() {
        ...
        const formatterOptions = {
            ...
            coverageOptions: (0, deployCommand_1.getCoverageFormattersOptions)(this.getFlag('coverageformatters', undefined)),
            junitTestResults: this.flags.junit,
            resultsDir: this.resultsDir,
            testsRan: !!((_a = this.deployResult) === null || _a === void 0 ? void 0 : _a.response.numberTestsTotal),
        };
