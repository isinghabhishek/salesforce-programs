...
class Pull extends sourceCommand_1.SourceCommand {
    ...
    resolveSuccess() {
        ...
        if ((_a = this.retrieveResult) === null || _a === void 0 ? void 0 : _a.response.status) {
            this.setExitCode((_b = StatusCodeMap.get(this.retrieveResult.response.status)) !== null && _b !== void 0 ? _b : 1);
        }
    }
    formatResult() {
