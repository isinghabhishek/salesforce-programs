...
class Report extends sourceCommand_1.SourceCommand {
    ...
    async report() {
        ...
        if (!retrieveId) {
            ...
            this.zipFileName = (0, sourceCommand_1.resolveZipFileName)(mdRetrieveStash === null || mdRetrieveStash === void 0 ? void 0 : mdRetrieveStash.zipfilename);
            ...
            this.zipFileName = (0, sourceCommand_1.resolveZipFileName)(this.getFlag('zipfilename'));
