...
class ResultFormatter {
    ...
    isVerbose() {
        var _a;
        return (_a = this.options.verbose) !== null && _a !== void 0 ? _a : false;
    }
    isQuiet() {
        var _a;
        return (_a = this.options.quiet) !== null && _a !== void 0 ? _a : false;
    }
    isConcise() {
        var _a;
        return (_a = this.options.concise) !== null && _a !== void 0 ? _a : false;
    }
    ...
    displayOutputFileLocations() {
        ...
        if (this.options.testsRan && ((_b = (_a = this.options.coverageOptions) === null || _a === void 0 ? void 0 : _a.reportFormats) === null || _b === void 0 ? void 0 : _b.length) > 0) {
    ...
    getCoverageFileInfo() {
        ...
        const formatters = (_a = this.options.coverageOptions) === null || _a === void 0 ? void 0 : _a.reportFormats;
        if (!formatters) {
            return undefined;
        }
        const reportOptions = ((_b = this.options.coverageOptions) === null || _b === void 0 ? void 0 : _b.reportOptions) || apex_node_1.DefaultReportOptions;
