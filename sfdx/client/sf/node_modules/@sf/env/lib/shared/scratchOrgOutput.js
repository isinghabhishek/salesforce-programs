...
const formatCurrentStage = (stage) => {
    return boldPurple((0, change_case_1.capitalCase)(stage));
};
exports.formatCurrentStage = formatCurrentStage;
const formatCompletedStage = (stage) => {
    return sf_plugins_core_1.StandardColors.success.bold(`✓ ${(0, change_case_1.capitalCase)(stage)}`);
};
exports.formatCompletedStage = formatCompletedStage;
const formatFutureStage = (stage) => {
    return sf_plugins_core_1.StandardColors.info((0, change_case_1.capitalCase)(stage));
};
