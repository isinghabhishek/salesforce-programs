...
exports.$$ = exports.test = exports.OclifConfig = exports.loadConfig = exports.command = exports.Config = exports.FancyTypes = exports.expect = void 0;
    ...
    return {
        ...
        run(ctx) {
            ...
            const writeOrg = async function () {
                ...
                return ((0, ts_types_1.ensure)($$.configStubs.GlobalInfo).contents = { orgs: { [org.username]: foundOrg } });
            };
...
const withProject = (SfProjectJson) => {
    return {
        run() {
            ...
            $$.SANDBOX.stub(core_2.SfProject, 'resolveProjectPath').callsFake((path) => {
